...
- **Text size.** Explainer text is larger by default (21px), and a slider sets the text size (85–160%) for passage cards and explainers together: in *You → Settings*, or from the *Aa* button at the top of any explainer. It's saved on the device.
